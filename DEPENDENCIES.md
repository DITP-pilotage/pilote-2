...
- `@pilote/kpilot-api` (`apps/kpilot-api`) : backend Hono (pilote MB)
- `@pilote/kpilot-webapp` (`apps/kpilot-webapp`) : webapp (pilote MB)
...
- `apps/kpilot-api` : `hono ^4.6.14 → ^4.12.18`, `@hono/node-server ^1.13.7 → ^1.19.13`
- `apps/kpilot-webapp` : `hono ^4.6.14 → ^4.12.18`, `@hono/node-server ^1.13.7 → ^1.19.13`
...
**Vérifications** : `pnpm lint` ✅ sur `pilote-ppg`, `kpilot-api` et `kpilot-webapp`.

...
(
	...
	{{ compute_ta_hausse_macro('vig', 'vca_prev_year', 'vacp') }} as unbounded_tap_prev_year,
...
(
	...
	{{ compute_ta_baisse_macro('vig', 'vca_prev_year', 'vacp') }} as unbounded_tap_prev_year,
...
get_bounded_ta as (
	...
	case when unbounded_tap_prev_year is null then null else greatest(least(unbounded_tap_prev_year, 100), 0)::numeric end as tap_prev_year,

...
#psql "$DATABASE_URL" -c "copy raw_data.mesure_indicateur (indic_id, metric_date, metric_type, metric_value, zone_id, id, rapport_id) from STDIN with csv delimiter ',' header;" < input_data/private_data/private_seeds/mesure_indicateur_202306271030.csv

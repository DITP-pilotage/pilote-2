...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Login                                | ✓       |  |  |  |  |  |  |
| Consultation chantier                | ✓       |  |  |  |  |  |  |
| Import données                       | ✓       |  |  |  |  |  |  |
| 1 Export CSV chantiers                | ✓       |  |  |  |  |  |  |
| 2 Export CSV indicateurs              | ✓       |  |  |  |  |  |  |
| 3 Export CSV historique               | ✓       |  |  |  |  |  |  |
| 4 Export CSV utilisateurs             | ✓       |  |  |  |  |  |  |
| PVA - Création/acceptation           |  |  | ✓       |  |  |  | ✓ |
| PVA - Refus                          |  |  |  |  |  | ✓       | ✓ |
| PVA - Acceptation modifiée           |  |  | ✓       |  |  |  | ✓ |
| PVA - Modif/suppression              |  |  | ✓       |  |  |  |  |
| PVA - Blocage maille                 |  | ✓       |  |  |  |  |  |
| PVA - Dir. projet (décisions)        |  |  |  |  |  |  | ✓ |
| API                                  | ✓       |  |  |  |  |  | ✓ |
| 1 Gestion - Vue admin + token         | ✓       |  |  |  |  |  |  |
| 2 Gestion - Visibilité + restrictions |  | ✓       |  |  |  |  |  |
| 3 Gestion - Périmètre restreint       |  |  | ✓       |  |  |  |  |
| 4 Gestion - Par chantiers             |  |  |  | ✓      |  |  |  |
| 5 Gestion - Accès refusé              |  |  |  |  | ✓       | ✓       | ✓ |
| 6 Gestion - Désactiver/réactiver      | ✓       |  |  |  |  |  |  |
| 7 Gestion - Filtres                   | ✓       |  |  |  |  |  |  |
| 8 Gestion - Multi-territoires         |  | ✓       |  |  |  |  |  |
| Indicateurs - Listing                | ✓       | ✓       |  |  |  |  | ✓ |
| Indicateurs - Formulaire             | ✓       | ✓       |  |  |  |  | ✓ |

...
BEGIN
  ...
  VALUES (gen_random_uuid(), 'ditp.admin@example.com', 'DITP', 'Admin', 'DITP_ADMIN', NOW(), NOW(), NOW(), NOW())
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'ditp.pilotage@example.com', 'DITP', 'Pilotage', 'DITP_PILOTAGE', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'premiere.ministre@example.com', 'Premiere', 'Ministre', 'PM_ET_CABINET', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'presidence@example.com', 'Presidence', 'Republique', 'PR', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'cabinet.mtfp@example.com', 'Cabinet', 'MTFP', 'CABINET_MTFP', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'cabinet.ministeriel@example.com', 'Cabinet', 'Ministériel', 'CABINET_MINISTERIEL', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'direction.admin.centrale@example.com', 'Direction', 'Admin centrale', 'DIR_ADMIN_CENTRALE', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'secretariat.general@example.com', 'Secretariat', 'General', 'SECRETARIAT_GENERAL', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'equipe.dir.projet@example.com', 'Directeur', 'Projet', 'EQUIPE_DIR_PROJET', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'coordinateur.region@example.com', 'Coordinateur', 'Region', 'COORDINATEUR_REGION', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'prefet.region@example.com', 'Prefet', 'Region', 'PREFET_REGION', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'services.deconcentres.region@example.com', 'Services deconcentres', 'Region', 'SERVICES_DECONCENTRES_REGION', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'coordinateur.departement@example.com', 'Coordinateur', 'Departement', 'COORDINATEUR_DEPARTEMENT', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'prefet.departement@example.com', 'Prefet', 'Departement', 'PREFET_DEPARTEMENT', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'services.deconcentres.departement@example.com', 'Services deconcentres', 'Departement', 'SERVICES_DECONCENTRES_DEPARTEMENT', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'drom@example.com', 'DROM', 'MIOM', 'DROM', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'pva.coordinateur.dept@example.com', 'PVA-Coordinateur', 'Departement', 'COORDINATEUR_DEPARTEMENT', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'pva.prefet.dept@example.com', 'PVA-Prefet', 'Departement', 'PREFET_DEPARTEMENT', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'pva.coordinateur.reg@example.com', 'PVA-Coordinateur', 'Region', 'COORDINATEUR_REGION', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;
  ...
  INSERT INTO public.utilisateur (id, email, nom, prenom, profil_code, date_creation, date_modification, date_visualisation_video_accueil, date_inscription_infolettre)
  VALUES (gen_random_uuid(), 'pva.dir.projet@example.com', 'PVA-Direction', 'Projet', 'EQUIPE_DIR_PROJET', NOW(), NOW(), NOW(), NOW())
  RETURNING id INTO v_user_id;

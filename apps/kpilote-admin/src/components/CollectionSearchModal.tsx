...
export function CollectionSearchModal({
  ...
  onSelect: (hit: CollectionHit) => void
  onClose: () => void
}) {
  ...
  const query = useInfiniteQuery(
    searchCollectionsInfiniteQueryOptions(recherche, rechercheIdentifiant),
  )

  const hits: CollectionHit[] = (query.data?.pages ?? [])
    ...
    >
      ...
      >
        ...
        <div className="mb-4 space-y-3">
          <div>
            <label
              htmlFor="collection-search-identifiant"
              className="mb-1.5 block text-xs font-semibold"
            >
              Identifiant
            </label>
            <input
              id="collection-search-identifiant"
              autoFocus
          ...
          <div>
            <label htmlFor="collection-search-nom" className="mb-1.5 block text-xs font-semibold">
              Nom
            </label>

...
export const modifierChantierCommandSchema = z.object({
...
export type ModifierChantierCommand = z.infer<
  typeof modifierChantierCommandSchema
>;

export class ModifierChantierHandler {
  ...
  async execute(command: ModifierChantierCommand): Promise<void> {
    await this.prisma.getInstance().metadata_chantiers.update({

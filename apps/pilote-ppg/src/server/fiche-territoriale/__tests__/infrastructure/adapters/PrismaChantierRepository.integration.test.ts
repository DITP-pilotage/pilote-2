...
describe("PrismaChantierRepository", () => {
  ...
  describe("listerParTerritoireCodePourUnDepartement", () => {
    describe("quand on est dans la maille département", () => {
      it(
        "doit récupérer les chantiers de la maille",
      ...
      it(
        "quand les chantier est territorialisé, doit récupérer ces chantiers",
        createIntegrationTest(async () => {
          // Given
          const territoireCode = "DEPT-34";
      ...
      it(
        "quand les chantier n'est pas dans le baromètre, ne doit pas récupérer ce chantier",
        createIntegrationTest(async () => {
          // Given
          const territoireCode = "DEPT-34";
      ...
      it(
        "quand le chantier_territoire n'est pas applicable, ne doit pas récupérer ce chantier",
        createIntegrationTest(async () => {
          // Given
          const territoireCode = "DEPT-34";

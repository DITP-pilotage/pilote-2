...
import { modifierDecisionStrategiqueBrouillon } from "@/server/domain/chantier/décisionStratégique/DécisionStratégique";

export class ModifierBrouillonDecisionStrategiqueUseCase {
  constructor(
  ...
  async execute({
    ...
    const decision = modifierDecisionStrategiqueBrouillon(brouillon, {
      contenu,
      auteurModificationId,
      dateModification,
    });

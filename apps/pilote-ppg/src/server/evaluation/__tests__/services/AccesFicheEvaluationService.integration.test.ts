...
describe("AccesFicheEvaluationService", () => {
  ...
  describe("peutAccederEtapeAutoEvaluation", () => {
    it(
      "doit retourner true quand l'utilisateur a la permission pour l'étape AUTO_EVALUATION",
    ...
    it(
      "doit retourner false quand l'utilisateur n'a aucune permission",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "doit retourner false quand l'utilisateur a une permission pour une étape différente",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "doit retourner false quand l'utilisateur a une permission pour un rattachement différent",
      createIntegrationTest(async () => {
        // Given
  ...
  describe("peutAccederEtapeConsolidation", () => {
    it(
      "doit retourner true quand l'utilisateur a la permission pour l'étape CONSOLIDATION",
      createIntegrationTest(async () => {
        // Given
        const rattachementCode = "REG-300";
        const utilisateurId = "6429fbb5-c4c3-4e98-a729-f35ab37ea512";
  ...
  describe("peutAccederEtapeInstruction", () => {
    it(
      "doit retourner true quand l'utilisateur a la permission pour l'étape INSTRUCTION",
      createIntegrationTest(async () => {
        // Given
  ...
  describe("peutAccederEtapePilotage", () => {
    it(
      "doit retourner true quand l'utilisateur a l'application PILOTE_EVAL_PILOTAGE",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "doit retourner true quand l'utilisateur a uniquement l'application PILOTE_EVAL_PILOTAGE",
      createIntegrationTest(async () => {
        // Given
        const applicationsAccessibles: $Enums.application_accessible[] = [
          $Enums.application_accessible.PILOTE_EVAL_PILOTAGE,
    ...
    it(
      "doit retourner false quand l'utilisateur n'a pas l'application PILOTE_EVAL_PILOTAGE",
      createIntegrationTest(async () => {
        // Given
        const applicationsAccessibles: $Enums.application_accessible[] = [
          $Enums.application_accessible.PILOTE,
    ...
    it(
      "doit retourner false quand l'utilisateur n'a aucune application",
      createIntegrationTest(async () => {
        // Given
        const applicationsAccessibles: $Enums.application_accessible[] = [];

...
describe("PrismaRapportRepository", () => {
  ...
  describe("#récupérerRapportParId", () => {
    it("doit récupérer le rapport avec les données", async () => {
      ...
      expect(rapportResult.listeMesuresIndicateurTemporaire[0].indicId).toEqual(
        "IND-001",
      );
      expect(
      ...
      expect(rapportResult.listeMesuresIndicateurTemporaire[0].zoneId).toEqual(
        "D001",
      );
      ...
      expect(rapportResult.listeMesuresIndicateurTemporaire[1].indicId).toEqual(
        "IND-002",
      );
      expect(
      ...
      expect(rapportResult.listeMesuresIndicateurTemporaire[1].zoneId).toEqual(
        "D002",
      );
    });
  });

...
describe("VerifierFichierIndicateurImporteUseCase", () => {
  ...
  beforeEach(() => {
    ...
    verifierFichierIndicateurImporteUseCase =
      new VerifierFichierIndicateurImporteUseCase({
        fichierIndicateurValidationService,
        mesureIndicateurTemporaireRepository,
        erreurValidationFichierRepository,
  ...
  it(
    "doit appeler le service de validation du fichier d'indicateur importé",
  ...
  it(
    ...
    createIntegrationTest(async () => {
      ...
      indicateurRepository.recupererInformationIndicateurParId.mockResolvedValue(
  ...
  it(
    "quand le fichier est valide, doit sauvegarder les données du fichier contenu dans le rapport",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
          ...
          .build();
      const mesureIndicateurTemporaire2 =
        new MesureIndicateurTemporaireBuilder()
          .avecIndicId("IND-001")
          .avecZoneId("D007")
      ...
      const detailValidationFichier = new DetailValidationFichierBuilder()
        ...
        .avecListeMesuresIndicateurTemporaire(
          mesureIndicateurTemporaire1,
          mesureIndicateurTemporaire2,
        )
        .build();
      const payload = {
        cheminCompletDuFichier: CHEMIN_COMPLET_DU_FICHIER,
  ...
  it(
    "quand le fichier est invalide, doit sauvegarder les erreurs du fichier contenu dans le rapport",
    createIntegrationTest(async () => {
      // Given
      const detailValidationFichier = new DetailValidationFichierBuilder()
      ...
      expect(reportFichierData[0].id).toBeDefined();
      expect(reportFichierData[0].rapportId).toEqual(
        "a0c086eb-21e2-4f00-9ca8-4b0fcce133ad",
      );
      ...
      expect(reportFichierData[1].id).toBeDefined();
      expect(reportFichierData[1].rapportId).toEqual(
        "a0c086eb-21e2-4f00-9ca8-4b0fcce133ad",
      );
  ...
  describe("quand le fichier est invalide", () => {
    it(
      "ne doit pas sauvegarder les données du fichier",
      createIntegrationTest(async () => {
        // Given
        const detailValidationFichier = new DetailValidationFichierBuilder()
          .avecEstValide(false)
    ...
    it(
      "quand l'indic_id est null, ne doit pas controler la valeur de l'indic_id",
      createIntegrationTest(async () => {
        // Given
        const mesureIndicateurTemporaire1 =
          new MesureIndicateurTemporaireBuilder()
    ...
    it(
      "quand au moins un indicateur est invalide, doit inclure les erreurs de validation des données du rapport",
      createIntegrationTest(async () => {
        // Given
        const mesureIndicateurTemporaire1 =
          new MesureIndicateurTemporaireBuilder()
        ...
        expect(report.listeErreursValidation[1].nom).toEqual(
          "Indicateur invalide",
        );
      }),
    );
  ...
  it(
    "quand le fichier possède des dates invalides, doit remonter un rapport invalide",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
      ...
      const mesureIndicateurTemporaire2 =
        new MesureIndicateurTemporaireBuilder()
          ...
          .build();
      const mesureIndicateurTemporaire3 =
        new MesureIndicateurTemporaireBuilder()
          .avecIndicId("IND-001")
          .avecMetricDate("2023-02-29")
          .build();
      const mesureIndicateurTemporaire4 =
        new MesureIndicateurTemporaireBuilder()
          .avecIndicId("IND-001")
      ...
      const detailValidationFichier = new DetailValidationFichierBuilder()
        ...
        .avecListeMesuresIndicateurTemporaire(
          mesureIndicateurTemporaire1,
          mesureIndicateurTemporaire2,
          mesureIndicateurTemporaire3,
          mesureIndicateurTemporaire4,
        )
        .build();
      const payload = {
        cheminCompletDuFichier: CHEMIN_COMPLET_DU_FICHIER,
  ...
  it(
    "quand le fichier possède des dates invalides au format DD/MM/YYYY ou MM-DD-YY, doit remonter un rapport invalide",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand le fichier possède une date valeur au format DD/MM/YYYY, doit convertir la date au format YYYY-MM-DD",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand le fichier possède une date valeur au format D/MM/YYYY, DD/M/YYYY ou D/M/YYYY, doit convertir la date au format YYYY-MM-DD",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
      ...
      const reportFichierData = indicateurCaptor.value;
      expect(reportFichierData).toHaveLength(4);
      ...
      expect(reportFichierData[1].indicId).toEqual("IND-001");
      expect(reportFichierData[1].zoneId).toEqual("D007");
      expect(reportFichierData[1].metricDate).toEqual("2023-06-02");
      expect(reportFichierData[1].metricType).toEqual("vc");
      expect(reportFichierData[1].metricValue).toEqual("14");
      ...
      expect(reportFichierData[2].metricType).toEqual("vc");
      expect(reportFichierData[2].metricValue).toEqual("14");

      expect(reportFichierData[3].id).toBeDefined();
      expect(reportFichierData[3].indicId).toEqual("IND-001");
      expect(reportFichierData[3].zoneId).toEqual("D007");
      expect(reportFichierData[3].metricDate).toEqual("2023-06-02");
      expect(reportFichierData[3].metricType).toEqual("vc");
      expect(reportFichierData[3].metricValue).toEqual("14");
    }),
  );

  it(
    "quand le fichier possède une date valeur au format MM-DD-YY, M-DD-YY, MM-D-YY ou M-D-YY, doit convertir la date au format YYYY-MM-DD",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
      ...
      const mesureIndicateurTemporaire4 =
        new MesureIndicateurTemporaireBuilder()
          .avecIndicId("IND-001")
          .avecZoneId("D007")
          .avecMetricDate("12-1-23")
          .avecMetricType("vc")
          .avecMetricValue("14")
          .build();

      const mesureIndicateurTemporaire5 =
        new MesureIndicateurTemporaireBuilder()
          .avecIndicId("IND-001")
          .avecZoneId("D007")
          .avecMetricDate("2-1-23")
          .avecMetricType("vc")
          .avecMetricValue("14")
          .build();
      ...
      const reportFichierData = indicateurCaptor.value;
      expect(reportFichierData).toHaveLength(5);
      ...
      expect(reportFichierData[2].indicId).toEqual("IND-001");
      expect(reportFichierData[2].zoneId).toEqual("D007");
      expect(reportFichierData[2].metricDate).toEqual("2023-03-31");
      expect(reportFichierData[2].metricType).toEqual("vc");
      expect(reportFichierData[2].metricValue).toEqual("14");
      ...
      expect(reportFichierData[3].indicId).toEqual("IND-001");
      expect(reportFichierData[3].zoneId).toEqual("D007");
      expect(reportFichierData[3].metricDate).toEqual("2023-12-01");
      expect(reportFichierData[3].metricType).toEqual("vc");
      expect(reportFichierData[3].metricValue).toEqual("14");

      expect(reportFichierData[4].id).toBeDefined();
      expect(reportFichierData[4].indicId).toEqual("IND-001");
      expect(reportFichierData[4].zoneId).toEqual("D007");
      expect(reportFichierData[4].metricDate).toEqual("2023-02-01");
      expect(reportFichierData[4].metricType).toEqual("vc");
      expect(reportFichierData[4].metricValue).toEqual("14");
    }),
  );

  it(
    "quand le fichier possède un type au format VC VI VA, doit convertir en minuscule",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand le fichier possède un zone id au format France, doit convertir en majuscule",
    createIntegrationTest(async () => {
      // Given
      const mesureIndicateurTemporaire1 =
        new MesureIndicateurTemporaireBuilder()

...
describe("PublierFichierIndicateurImporteUseCase", () => {
  ...
  it(
    "doit transférer les mesures temporaires des indicateurs vers le repository permanent",
  ...
  it(
    "quand la valeur est nouvelle pour le tuple [indicateur, territoire, date, type], doit créer une ligne d'évènement (VALEUR_CREEE)",
    createIntegrationTest(async () => {
      // Given
  ...
  it(
    `quand la valeur est chaine de caractère vide pour le tuple [indicateur, territoire, date, type], ne doit pas créer d'évènement ${EvenementValeurEnum.VALEUR_CREEE}`,
    createIntegrationTest(async () => {
      // Given
      const listeMesuresIndicateursTemporaires = [
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    `quand la valeur est chaine de caractère vide pour le tuple [indicateur, territoire, date, type] avec un tuple pour une date antérieur, ne doit pas créer d'évènement (${EvenementValeurEnum.VALEUR_CREEE}, ${EvenementValeurEnum.VALEUR_HISTORISEE})`,
    createIntegrationTest(async () => {
      // Given
      const listeMesuresIndicateursTemporaires = [
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    `quand il existe une valeur pour le tuple [indicateur, territoire, date, type] et que la nouvelle valeur est chaine de caractère vide, doit créer un évènement ${EvenementValeurEnum.VALEUR_MODIFIEE} avec valeur null`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    `quand la valeur est nouvelle pour le tuple [indicateur, territoire, date, type] et que la valeur est null, et un nouveau tuple pour une date identique et valeur non null dans le même import, doit créer 3 lignes d'évènement (${EvenementValeurEnum.VALEUR_CREEE} + ${EvenementValeurEnum.VALEUR_MODIFIEE} à null + ${EvenementValeurEnum.VALEUR_MODIFIEE}) - en batch`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
      ...
      expect(evenementModifieeJanvier.dateValeur).toEqual(
        new Date("2023-01-01"),
      );
  ...
  it(
    `Meme import, valeur janvier -> valeur janvier devient null -> valeur fevrier (${EvenementValeurEnum.VALEUR_CREEE} + janvier ${EvenementValeurEnum.VALEUR_MODIFIEE} janvier à null + ${EvenementValeurEnum.VALEUR_HISTORISEE} janvier + ${EvenementValeurEnum.VALEUR_CREEE} fevrier)`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    `Meme import, valeur janvier -> valeur fevrier -> valeur janvier devient null (${EvenementValeurEnum.VALEUR_CREEE} janvier + ${EvenementValeurEnum.VALEUR_HISTORISEE} janvier + ${EvenementValeurEnum.VALEUR_CREEE} fevrier + ${EvenementValeurEnum.VALEUR_MODIFIEE} janvier à null)`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    `valeur janvier 01 -> valeur janvier 05 (${EvenementValeurEnum.VALEUR_MODIFIEE} janvier)`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
      ...
      expect(evenementModifieJanvier.dateValeur).toEqual(
        new Date("2023-01-01"),
      );
  ...
  it(
    `quand la valeur est nouvelle pour le tuple [indicateur, territoire, date, type] et que la valeur est null, et un nouveau tuple pour une date supérieure et valeur non null, doit créer 2 lignes d'évènements (${EvenementValeurEnum.VALEUR_HISTORISEE} + ${EvenementValeurEnum.VALEUR_CREEE})`,
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand la valeur est nouvelle pour le tuple [indicateur, territoire, date, type] avec un tuple pour une date antérieure, doit créer 2 lignes d'évènement (VALEUR_HISTORISEE + VALEUR_CREEE)",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand la valeur est nouvelle pour le tuple [indicateur, territoire, date, type] avec un tuple pour une date supérieure, doit créer 2 lignes d'évènement (VALEUR_CREEE + VALEUR_HISTORISEE)",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand la valeur est différente de la dernière valeur importée pour le tuple [indicateur, territoire, date, type], doit créer une ligne d'évènement (VALEUR_MODIFIEE)",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand la valeur est identique à la dernière valeur importée pour le tuple [indicateur, territoire, date, type], ne doit pas créer de ligne d'évènement",
    createIntegrationTest(async () => {
      // Given
      const listeMesuresIndicateursTemporaires = [
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand plusieurs valeurs pour le même indicateur/territoire sont importées dans le même batch, doit tenir compte des événements créés précédemment dans le batch",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_CREEE pour le tuple [indicateur, territoire, date, type], doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_MODIFIEE et VALEUR_MODIFIEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_MODIFIEE avec une valeur différente pour le tuple [indicateur, territoire, date, type], doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_MODIFIEE et VALEUR_MODIFIEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_ACCUSEE_RECEPTION avec une valeur différente pour le tuple [indicateur, territoire, date, type], doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_MODIFIEE et VALEUR_MODIFIEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement VALEUR_CREE avec la même valeur pour le tuple [indicateur, territoire, date, type], ne doit pas créer d'évènement",
    createIntegrationTest(async () => {
      // Given
      const listeMesuresIndicateursTemporaires = [
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement VALEUR_MODIFIEE avec la même valeur, ne doit pas créer d'évènement",
    createIntegrationTest(async () => {
      // Given
      const listeMesuresIndicateursTemporaires = [
        new MesureIndicateurTemporaireBuilder()
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_CREEE avec une valeur différente pour une date antérieure, doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_HISTORISEE et VALEUR_CREEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_MODIFIEE avec une valeur différente pour une date antérieure, doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_HISTORISEE et VALEUR_CREEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [
  ...
  it(
    "quand une nouvelle valeur est importée et qu'il existe un évènement PROPOSITION_VALEUR_ACCUSEE_RECEPTION avec une valeur différente pour une date antérieure, doit créer les évènements PROPOSITION_VALEUR_IGNOREE_VALEUR_HISTORISEE et VALEUR_CREEE",
    createIntegrationTest(async () => {
      // Given
      const evenementCaptor = captor<IndicateurTerritoireValeurEvenement[]>();
      const listeMesuresIndicateursTemporaires = [

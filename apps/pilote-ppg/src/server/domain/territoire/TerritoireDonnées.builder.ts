...
export default class TerritoireDonnéesBuilder {
  ...
  private _nombrePropositionValeur: TerritoireDonnées["nombrePropositionValeur"];

  private _nombrePropositionValeurPonderee: TerritoireDonnées["nombrePropositionValeurPonderee"];
  ...
  constructor() {
    ...
    this._avancementPrécédent = faker.helpers.arrayElement([
      this._avancement,
    ...
    this._dateDeMàjDonnéesQualitatives = générerPeutÊtreNull(
      0.2,
      faker.date.past().toISOString(),
    );
    this._dateDeMàjDonnéesQuantitatives = générerPeutÊtreNull(
      0.2,
      faker.date.past().toISOString(),
    );
    ...
    this._nombrePropositionValeurPonderee = 0;
    this._dateTauxAvancementMandatValeurPrecedent = générerPeutÊtreNull(
      0.2,
      faker.date.past().toISOString(),
    );
  ...
  avecCodeInsee(
    codeInsee: TerritoireDonnées["codeInsee"],
  ): TerritoireDonnéesBuilder {
  ...
  build(): TerritoireDonnées {
    return {
      ...
      territoireCode: this._codeInsee,
      ...
      nombrePropositionValeur: this._nombrePropositionValeur,

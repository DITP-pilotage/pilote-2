...
describe("EnregistrerMetadataIndicateurHandler", () => {
  ...
  describe("execute", () => {
    it(
      "doit créer de nouvelles métadonnées quand aucune n'existe",
    ...
    it(
      "doit mettre à jour des métadonnées existantes",
      createIntegrationTest(async () => {
    ...
    it(
      "doit supprimer les métadonnées qui ne sont plus dans la liste",
      createIntegrationTest(async () => {
    ...
    it(
      "doit créer les valeurs acceptées pour un multi-select",
      createIntegrationTest(async () => {
        // Given
        const command = {
          metadataList: [
    ...
    it(
      "doit remplacer les valeurs acceptées lors d'une mise à jour",
      createIntegrationTest(async () => {
    ...
    it(
      "doit gérer les valeurs par défaut de différents types",
      createIntegrationTest(async () => {
        // Given
        const command = {
          metadataList: [

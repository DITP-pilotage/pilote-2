...
describe("RécupérerInformationMetadataIndicateurUseCase", () => {
  ...
  it(
    "source les valeurs acceptées de zg_applicable depuis metadata_zonegroup, pas depuis metadata_indicateur_valeur_acceptee",
  ...
  it(
    "source les valeurs acceptées d'une metadata standard depuis metadata_indicateur_valeur_acceptee",
    createIntegrationTest(async () => {
      // Given
      await prisma.metadata_indicateur.create({
        data: {

...
export class MetadataParametrageIndicateur {
  ...
  avecPonderationsDeclarees({
    ...
    return MetadataParametrageIndicateur.creerMetadataParametrageIndicateur({
      ...
      viDeptFrom: this.viDeptFrom,
      viDeptOp: this.viDeptOp,
      vaDeptFrom: this.vaDeptFrom,
      vaDeptOp: this.vaDeptOp,
      vcDeptFrom: this.vcDeptFrom,
      vcDeptOp: this.vcDeptOp,
      viRegFrom: this.viRegFrom,
      viRegOp: this.viRegOp,
      vaRegFrom: this.vaRegFrom,
      vaRegOp: this.vaRegOp,
      vcRegFrom: this.vcRegFrom,
      vcRegOp: this.vcRegOp,
      viNatFrom: this.viNatFrom,
      viNatOp: this.viNatOp,
      vaNatFrom: this.vaNatFrom,
      vaNatOp: this.vaNatOp,
      vcNatFrom: this.vcNatFrom,
      vcNatOp: this.vcNatOp,
      paramVacaDecumulFrom: this.paramVacaDecumulFrom,
      paramVacaPartitionDate: this.paramVacaPartitionDate,
      paramVacaOp: this.paramVacaOp,
      paramVacgDecumulFrom: this.paramVacgDecumulFrom,
      paramVacgPartitionDate: this.paramVacgPartitionDate,
      paramVacgOp: this.paramVacgOp,
      poidsPourcentDept: poidsPourcentDept as number,
      poidsPourcentReg: poidsPourcentReg as number,
      poidsPourcentNat: poidsPourcentNat as number,
      poidsPourcentEvalNat: this.poidsPourcentEvalNat,
      poidsPourcentEvalReg: this.poidsPourcentEvalReg,
      poidsPourcentEvalDept: this.poidsPourcentEvalDept,
      tendance: this.tendance,
      indicParentIndic: this.indicParentIndic,
      indicParentCh: this.indicParentCh,
      indicNom: this.indicNom,
      indicNomBaro: this.indicNomBaro,
      indicDescr: this.indicDescr,
      indicDescrBaro: this.indicDescrBaro,
      indicIsPerseverant: this.indicIsPerseverant,
      indicIsPhare: this.indicIsPhare,
      indicIsBaro: this.indicIsBaro,
      indicType: this.indicType,
      indicSource: this.indicSource,
      indicSourceUrl: this.indicSourceUrl,
      indicMethodeCalcul: this.indicMethodeCalcul,
      indicUnite: this.indicUnite,
      indicHiddenPilote: this.indicHiddenPilote,
      indicSchema: this.indicSchema,
      zgApplicable: this.zgApplicable,
      chantierNom: this.chantierNom,
      reformePrioritaire: this.reformePrioritaire,
      projetAnnuelPerf: this.projetAnnuelPerf,
      detailProjetAnnuelPerf: this.detailProjetAnnuelPerf,
      periodicite: this.periodicite,
      delaiDisponibilite: this.delaiDisponibilite,
      indicTerritorialise: this.indicTerritorialise,
      frequenceTerritoriale: this.frequenceTerritoriale,
      mailles: this.mailles,
      adminSource: this.adminSource,
      methodeCollecte: this.methodeCollecte,
      siSource: this.siSource,
      donneeOuverte: this.donneeOuverte,
      modalitesDonneeOuverte: this.modalitesDonneeOuverte,
      respDonnees: this.respDonnees,
      respDonneesEmail: this.respDonneesEmail,
      contactTechnique: this.contactTechnique,
      contactTechniqueEmail: this.contactTechniqueEmail,
      commentaire: this.commentaire,
      maillePilotage: this.maillePilotage,
      cibleAttendue: this.cibleAttendue,
      couvertureTemporelle: this.couvertureTemporelle,
    });
  }

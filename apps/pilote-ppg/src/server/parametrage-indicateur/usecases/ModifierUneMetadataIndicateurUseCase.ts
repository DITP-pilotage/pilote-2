...
export default class ModifierUneMetadataIndicateurUseCase {
  ...
  async run(auteurId: string, inputs: MetadataParametrageIndicateurForm) {
    const metadataParametrageIndicateurAncien =
      await this.metadataParametrageIndicateurRepository.recupererMetadataParametrageIndicateurParIndicId(
        inputs.indicId,
      );

    const metadataParametrageIndicateurNouveau =
      MetadataParametrageIndicateur.creerMetadataParametrageIndicateur({
        ...inputs,
    ...
    const historisationParametrageModification =
      HistorisationModification.creerHistorisationModification({
        auteurId,
    ...
    const historisationIndicateurComplementaireModification =
      HistorisationModification.creerHistorisationModification({
        auteurId,
    ...
    return this.metadataParametrageIndicateurRepository.modifier(
      metadataParametrageIndicateurNouveau,
    );
  }
}

...
describe("PrismaIndicateurTerritoireValeurEvenementRepository", () => {
  ...
  describe("#enregistrer", () => {
    it(
      "Doit enregistrer un événement indicateur territoire valeur",
  ...
  describe("#enregistrerTous", () => {
    it(
      "Doit enregistrer plusieurs événements avec enregistrerTous",
      createIntegrationTest(async () => {
        // Given
        ...
        expect(evenements[1].type_evenement).toBe(
  ...
  describe("#recupererParIndicIdTerritoireCodeEtTypeValeur", () => {
    it(
      "Doit récupérer les événements par indicId, territoireCode et typeValeur",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit récupérer les événements par indicId, territoireCode, typeValeur et date",
      createIntegrationTest(async () => {
        // Given
        ...
        expect(evenementsSurDate.evenementsSurDate[0].dateValeur).toEqual(
          date1,
        );
        expect(evenementsSurDate.evenementsSurDate[1].dateValeur).toEqual(
          date1,
        );
    ...
    it(
      "Doit retourner un tableau vide quand aucun événement ne correspond aux critères",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit trier les événements par date décroissante puis par ordre décroissant",
      createIntegrationTest(async () => {
        // Given
  ...
  describe("#recupererParIndicIdTerritoireCodeTypeValeurEtDateSuperieureA", () => {
    it(
      "Doit récupérer tous les événements avec une date supérieure à la date donnée, groupés par date",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit retourner un tableau vide quand aucun événement n'a une date supérieure",
      createIntegrationTest(async () => {
        // Given
  ...
  describe("#recupererHistoriqueParIndicIdEtTerritoireCode", () => {
    it(
      "Doit récupérer l'historique complet des événements par indicId et territoireCode",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit retourner un tableau vide pour l'historique quand aucun événement ne correspond",
      createIntegrationTest(async () => {
        // When
        const evenements =
          await prismaIndicateurTerritoireValeurEvenementRepository.recupererHistoriqueParIndicIdEtTerritoireCode(
  ...
  describe("#recupererLesPropositionsEnCoursParChantierIds", () => {
    it(
      "Doit récupérer les propositions en cours groupées par chantier et indicateur",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit filtrer les propositions selon leur statut pour ne garder que les propositions en cours",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit ne garder que le dernier événement par triplet (indicId, territoireCode, dateValeur)",
      createIntegrationTest(async () => {
        // Given
    ...
    it(
      "Doit exclure les propositions dont l'indicateur ou le chantier n'est pas publié",
      createIntegrationTest(async () => {
        // Given

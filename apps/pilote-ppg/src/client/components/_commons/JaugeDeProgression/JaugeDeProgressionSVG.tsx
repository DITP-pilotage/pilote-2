...
const TRACÉS = {
  ...
  md: {
    tracéSVG:
      "M.68.953C.684.961.69.961.695.961A.505.505 0 0 0 .992.402.505.505 0 0 0 .508 0a.5.5 0 0 0-.215.953C.297.957.305.953.309.95l.03-.078C.345.863.34.86.337.855a.388.388 0 0 1-.082-.66.395.395 0 0 1 .422-.047.395.395 0 0 1-.02.711C.648.863.648.867.648.875Zm0 0",
    angleDépart: 23,
    amplitudeAngulaire: 316,
  },
  lg: {
...
const JaugeDeProgressionSVG: FunctionComponent<JaugeDeProgressionSVGProps> = ({
  pourcentage,
  taille,
  couleur,
}) => {
    ...
    >
      ...
      <defs>
        <clipPath id={`masque-${id}`}>
          <path d={TRACÉS[taille || "lg"].tracéSVG} />
        </clipPath>
      </defs>
    </svg>
  );

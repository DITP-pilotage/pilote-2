...
const TableauPagination: FunctionComponent<PaginationProps> = ({
  nombreDePages,
  changementDePageCallback,
  numéroDePageInitiale,
}) => {
  const [numéroDePageCourante, setNuméroDePageCourante] =
    useState(numéroDePageInitiale);
  ...
  const aLaDeuxièmeTroncature = () =>
    numéroDePageCourante <= numéroDernièrePage - 3;
          ...
          <>
            ...
            {aLaPremièreTroncature() && aLaDeuxièmeTroncature() && (
              <>
                <TableauPaginationÉlément
                  changementDePageCallback={() =>
                    changerPage(numéroPagePrécédente)
                  }
                  estLaPageCourante={false}
                ...
                <TableauPaginationÉlément
                  changementDePageCallback={() =>
                    changerPage(numéroDePageCourante)
                  }
                  estLaPageCourante
                ...
                <TableauPaginationÉlément
                  changementDePageCallback={() =>
                    changerPage(numéroPageSuivante)
                  }
                  estLaPageCourante={false}
            ...
            {numéroDePageCourante === numéroDernièrePage - 2 && (
              <TableauPaginationÉlément
                changementDePageCallback={() =>
                  changerPage(numéroDernièrePage - 3)
                }
                estLaPageCourante={false}
            ...
            {!aLaDeuxièmeTroncature() &&
              numéroDePageCourante <= numéroDernièrePage - 1 && (
                <TableauPaginationÉlément
                  changementDePageCallback={() =>
                    changerPage(numéroDernièrePage - 2)
                  }
                  estLaPageCourante={
                    numéroDePageCourante === numéroDernièrePage - 2
                  }
            ...
            {numéroDePageCourante >= numéroDernièrePage - 2 && (
              <TableauPaginationÉlément
                changementDePageCallback={() =>
                  changerPage(numéroDernièrePage - 1)
                }
                estLaPageCourante={
                  numéroDePageCourante === numéroDernièrePage - 1
                }

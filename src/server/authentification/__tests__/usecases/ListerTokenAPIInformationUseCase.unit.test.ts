...
describe("ListerTokenAPIInformationUseCase", () => {
  ...
  beforeEach(() => {
    ...
    listerTokenAPIInformationUseCase = new ListerTokenAPIInformationUseCase({
  ...
  it("doit récupérer la liste des tokens api", async () => {
    ...
    tokenAPIInformationRepository.listerTokenAPIInformation.mockResolvedValue([
      tokenAPIInformation1,
      tokenAPIInformation2,
    ]);

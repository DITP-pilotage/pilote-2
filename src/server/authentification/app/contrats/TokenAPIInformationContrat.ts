...
export type TokenAPIInformationContrat = {
  email: string;
  dateExpiration: string;
};

export const presenterEnTokenAPIInformationContrat = (
  tokenApi: TokenAPIInformation,
  ...
  return {
    ...
    dateExpiration:
      formaterDate(dateExpiration.toISOString(), "DD/MM/YYYY") ||
      "Erreur date expiration",
  };
};

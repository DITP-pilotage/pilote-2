...
export const getFicheConducteurContainer = (initialContainer: AwilixContainer<{ prisma: PrismaPilote }>): AwilixContainer<FicheConducteurDependencies & { prisma: PrismaPilote }> => {
  ...
  return initialContainer.createScope<FicheConducteurDependencies>().register({
    ...
    recupererChantierFicheConducteurUseCase: asClass(RécupererChantierFicheConducteurUseCase),
    recupererAvancementUseCase: asClass(RécupérerAvancementUseCase),
    recupererDerniereSyntheseDesResultatsUseCase: asClass(RécupérerDernièreSynthèseDesRésultatsUseCase),
    recupererDonneesCartographieUseCase: asClass(RécupérerDonnéesCartographieUseCase),
    ...
    synthèseDesRésultatsRepository: asClass(PrismaSynthèseDesRésultatsRepository),

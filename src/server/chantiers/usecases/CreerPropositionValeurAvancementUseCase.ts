...
export class CreerPropositionValeurAvancementUseCase {
  ...
  async run({
    ...
    await this.propositionValeurAvancementRepository.annulePropositionValeurAvancementPrecedente({ indicId, territoireCode });
    
    const propositionValeurAvancement = PropositionValeurAvancement.creerPropositionValeurAvancement({
      indicId,
      valeurAvancementProposee,
      territoireCode,
      dateValeurAvancement,
    ...
    await this.propositionValeurAvancementRepository.creerPropositionValeurAvancement(propositionValeurAvancement);
  }
}

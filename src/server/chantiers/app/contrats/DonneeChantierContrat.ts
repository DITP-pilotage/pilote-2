...
export const presenterEnDonneeTerritoireChantierContrat = (
  ...
  return {
    ...
    taux_avancement_region: formaterNumériqueOuValeurNonApplicable(
      donneeChantier.tauxDAvancementRégional,
    ),
    ...
    publication: {
      ...
      autres_resultats_non_coreeles_aux_indic:
        donneeChantier.commAutresRésultatsNonCorrélésAuxIndicateurs,
      ...
      commentaires_sur_les_donnees:
        donneeChantier.commCommentairesSurLesDonnées,

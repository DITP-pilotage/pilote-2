...
describe("PrismaPropositionValeurAvancementRepository", () => {
  ...
  describe("#supprimerPropositionValeurAvancement", () => {
    it("doit appliquer le statut RETIREE à la proposition de valeur avancement avec le statut EN_COURS", async () => {
      ...
      expect(propositions[1].statut).toStrictEqual(
  ...
  describe("#creerPropositionValeurAvancement", () => {
    it("doit creer la proposition de valeur avancement", async () => {
      ...
      const propositionValeurAvancement =
        new PropositionValeurAvancementBuilder()
          ...
          .build();
      // When
      await prismaPropositionValeurAvancementRepository.creerPropositionValeurAvancement(
        propositionValeurAvancement,
      );
      // Then
      const propositionValeurAvancementCree =
        await prisma.proposition_valeur_actuelle.findFirst({
          where: {

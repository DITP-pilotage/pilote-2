...
describe("ExportCsvDesChantiersUseCase", () => {
  ...
  it("Renvoie une liste vide si pas de chantiers", async () => {
    ...
    const exportCsvDesChantiersSansFiltreUseCase =
      new ExportCsvDesChantiersUseCase({ chantierRepository });
  ...
  it("Délègue l'habilitation aux repositories", async () => {
    ...
    // Then
    expect(chantierRepository.récupérerPourExports).toHaveBeenCalledWith(
      chantierId,
      territoireCodes,
      optionsExport,
      jalon,
  ...
  it("Renvoie 3 lignes pour 3 chantiers si configuré avec lots de 3", async () => {
    ...
    const chantier1 = new ChantierPourExportBuilder()
      .avecId("CH-001")
      .avecNom("Chantier CH-001")
      .build();
    const chantier2 = new ChantierPourExportBuilder()
      .avecId("CH-002")
      .avecNom("Chantier CH-002")
      .build();
    const chantier3 = new ChantierPourExportBuilder()
      .avecId("CH-003")
      .avecNom("Chantier CH-003")
      .build();
    ...
    // Then
    expect(result).toEqual(
      [["Chantier CH-001"], ["Chantier CH-002"], ["Chantier CH-003"]].map(
  ...
  it("Renvoie 4 lignes pour 4 chantiers si configuré avec lots de 3", async () => {
    ...
    const chantier3 = new ChantierPourExportBuilder()
      ...
      .avecNom("Chantier CH-003")
      .build();
    const chantier4 = new ChantierPourExportBuilder()
      .avecId("CH-004")
      .avecNom("Chantier CH-004")
      .build();

...
class Dependencies {
  ...
  constructor() {
    ...
    this._synthèseDesRésultatsRepository =
      new SynthèseDesRésultatsSQLRepository();
    this._commentaireRepository = new CommentaireSQLRepository();
    this._objectifRepository = new ObjectifSQLRepository();
    this._décisionStratégiqueRepository =
      new DécisionStratégiqueSQLRepository();
    this._utilisateurRepository = new UtilisateurSQLRepository();
    this._authentificationUtilisateurRepository =
      new PrismaUtilisateurRepository();
    this._authentificationProfilRepository = new PrismaProfilRepository();
    this._territoireRepository = new TerritoireSQLRepository();
    this._ficheTerritorialeTerritoireRepository =
      new PrismaTerritoireRepository();
    this._ficheTerritorialeChantierRepository = new PrismaChantierRepository();
    this._ficheTerritorialeIndicateurRepository =
      new PrismaFicheTerritorialeIndicateurRepository();
    this._ficheTerritorialeSyntheseDesResultatsRepository =

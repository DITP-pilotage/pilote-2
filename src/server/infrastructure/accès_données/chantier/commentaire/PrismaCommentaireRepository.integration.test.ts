...
import { PrismaCommentaireRepository, CODES_TYPES_COMMENTAIRES } from '@/server/infrastructure/accès_données/chantier/commentaire/PrismaCommentaireRepository';
...
describe('CommentaireSQLRepository', () => {
  ...
  beforeEach(() => {
    ...
    prismaCommentaireRepository = new PrismaCommentaireRepository({ prisma: prismaPilote });
  });

...
describe('PrismaSyntheseDesResultatsRepository ', function () {
  let  synthèseDesRésultatsRepository: PrismaSyntheseDesResultatsRepository;
  let prisma: PrismaClient  ;
  beforeEach(() => {
    const prismaPilote = new PrismaPilote();
    prisma = prismaPilote.getInstance();
    synthèseDesRésultatsRepository = new PrismaSyntheseDesResultatsRepository({ prisma: prismaPilote });
  });

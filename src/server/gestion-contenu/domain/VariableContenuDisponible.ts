...
export const FEATURE_FLIP_LABELS: Record<FeatureFlipKey, string> = {
  ...
  NEXT_PUBLIC_FF_RAPPORT_DETAILLE: "Rapport détaillé",
  NEXT_PUBLIC_FF_INFOBULLE_PONDERATION: "Infobulle pondération",
  NEXT_PUBLIC_FF_DATE_METEO: "Date météo",
  ...
  NEXT_PUBLIC_FF_SUIVI_COMPLETUDE: "Suivi complétude",
  ...
  NEXT_PUBLIC_FF_VIDEO_ACCUEIL: "Vidéo accueil",
  ...
  NEXT_PUBLIC_FF_CREATION_COMPTE_ARS: "Création compte ARS",
  NEXT_PUBLIC_FF_MASQUER_INDICATEURS_NON_APPLICABLES:
    "Masquer indicateurs non applicables",
  NEXT_PUBLIC_FF_ACCES_PILOTE: "Accès Pilote",
  ...
  NEXT_PUBLIC_FF_PVA_VALEUR_DIFFERENTE: "PVA valeur différente",

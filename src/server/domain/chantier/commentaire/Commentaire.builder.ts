...
export default class CommentaireBuilder {
  ...
  constructor() {
    this._commentaireSurLesDonnées = générerPeutÊtreNull(
      0.1,
      this._générerUnCommentaire("commentairesSurLesDonnées"),
    );
    this._autresRésultatsObtenus = générerPeutÊtreNull(
      0.1,
      this._générerUnCommentaire("autresRésultatsObtenus"),
    );
    this._autresRésultatsObtenusNonCorrélésAuxIndicateurs = générerPeutÊtreNull(
      0.5,
      this._générerUnCommentaire(
        "autresRésultatsObtenusNonCorrélésAuxIndicateurs",
      ),
    );
    this._risquesEtFreinsÀLever = générerPeutÊtreNull(
      0.1,
      this._générerUnCommentaire("risquesEtFreinsÀLever"),
    );
    this._solutionsEtActionsÀVenir = générerPeutÊtreNull(
      0.1,
      this._générerUnCommentaire("solutionsEtActionsÀVenir"),
    );
    this._exemplesConcretsDeRéussite = générerPeutÊtreNull(
      0.1,
      this._générerUnCommentaire("exemplesConcretsDeRéussite"),
    );
  }

...
import { ChantierId, Habilitation, Scope, checkAuthorizationChantierScope, ScopeSet, récupereListeChantierAvecScope } from './Habilitation';
...
export default describe('Habilitation', () => {

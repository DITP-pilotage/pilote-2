...
export const profilsDépartementaux = ['PREFET_DEPARTEMENT', 'COORDINATEUR_DEPARTEMENT', 'SERVICES_DECONCENTRES_DEPARTEMENT', 'RESPONSABLE_DEPARTEMENT'] as const;
export const profilsRégionaux = ['PREFET_REGION', 'COORDINATEUR_REGION', 'SERVICES_DECONCENTRES_REGION', 'SERVICES_DECONCENTRES_REGION', 'RESPONSABLE_REGION'] as const;

...
describe('PrismaCommentaireRepository', () => {
  ...
  describe('#anonymiserAuteurs', () => {
    test('doit anonymiser l\'auteur des commentaires saisis par l\'utilisateur supprimé', async () => {
      ...
      expect(commentairesAvecAuteurAnonyme[0].id).toStrictEqual('b699907e-43c4-43be-8d8d-185fca1b2e50');
      expect(commentairesAvecAuteurAnonyme[1].id).toStrictEqual('e3885e40-caab-4fb6-acf4-0c8f66c9e290');
    });
  });
});

...
export interface ChantierRepository {
  récupérerChantiersSynthétisés({ listeChantierIdLecture }: { listeChantierIdLecture: string[] }): Promise<ChantierSynthetise[]>;
  listerInformationsChantiersUtilisateurs(): Promise<InformationChantierUtilisateur[]>;
}

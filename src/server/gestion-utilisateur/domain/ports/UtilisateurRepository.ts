...
export interface UtilisateurRepository {
  ...
  recupererEtatVisualisationVideoAccueil(
    utilisateurId: string,
  ): Promise<boolean>;
  recupererDateVisualisationVideoAccueil(
    utilisateurId: string,
  ): Promise<Date | null>;
  desactiverVideoAccueil(
    utilisateurId: string,
  ...
  recupererDateInscriptionInfolettre(
    utilisateurId: string,
  ): Promise<Date | null>;
  recupererDateVisualisationPopupInfolettre(
    utilisateurId: string,
  ): Promise<Date | null>;
  mettreAJourLaDateInscriptionInfolettre(
    email: string,
    dateInscriptionInfolettre: Date,
  ): Promise<void>;
  mettreAJourLaDateVisulationPopupInfolettre(
    utilisateurId: string,

...
type AvailableInformationMetadataIndicateur =
  | "indic_id"
  | "indic_parent_indic"
  | "indic_parent_ch"
  | "indic_nom"
...
export const presenterEnInformationMetadataIndicateurContrat = (
  ...
  return {
    ...
    metaPiloteEditIsEditable:
      informationMetadataIndicateur.metaPiloteEditIsEditable || false,
    metaPiloteEditRegex:
      informationMetadataIndicateur.metaPiloteEditRegex || "",
    metaPiloteEditRegexViolationMessage:
      informationMetadataIndicateur.metaPiloteEditRegexViolationMessage || "",
    metaPiloteEditBoxType:
      informationMetadataIndicateur.metaPiloteEditBoxType || "",
    metaPiloteDefaultValue:
      informationMetadataIndicateur.metaPiloteDefaultValue,
    ...
    acceptedValues: informationMetadataIndicateur.acceptedValues.map(
      (acceptedValue) => ({
...
export const presenterEnMapInformationMetadataIndicateurContrat = (
  listeInformationMetadataIndicateur: InformationMetadataIndicateur[],
): MapInformationMetadataIndicateurContrat => {
  return listeInformationMetadataIndicateur.reduce((obj, valeur) => {
    obj[valeur.name as AvailableInformationMetadataIndicateur] =
      presenterEnInformationMetadataIndicateurContrat(valeur);
    return obj;

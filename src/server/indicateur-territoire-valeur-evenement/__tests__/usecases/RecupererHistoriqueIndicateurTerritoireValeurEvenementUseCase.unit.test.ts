  ...
  it("Doit grouper les événements par dateValeur et les trier correctement", async () => {
    ...
    const expectedResult = {
      "2024-02-01T00:00:00.000Z": [
        ...
        {
          id: event4.id,
          indicId: event4.indicId,
          territoireCode: event4.territoireCode,
          typeEvenement: event4.typeEvenement,
          typeValeur: event4.typeValeur,
          dateValeur: event4.dateValeur,
          dateCreation: event4.dateCreation,
          valeur: event4.valeur,
          donneesComplementaires: event4.donneesComplementaires,
          idAuteurModification: event4.idAuteurModification,
          correlationId: event4.correlationId,
          ordre: event4.ordre,
        },
        {
          id: event1.id,

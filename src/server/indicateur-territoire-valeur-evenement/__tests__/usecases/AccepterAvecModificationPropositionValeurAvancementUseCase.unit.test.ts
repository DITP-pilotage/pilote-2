...
describe("AccepterAvecModificationPropositionValeurAvancementUseCase", () => {
  ...
  it("Doit accepter avec modification une proposition de valeur d'avancement et envoyer les emails aux auteurs et coordinateurs", async () => {
    // Given
    const input = {
      indicId: "IND-006",
    ...
    expect(
      ...
      parametres: {
        ...
        va_actuelle: 3,
        va_proposee: 20,
        valeur_acceptee: input.valeur,
        motif_modification: input.motif,
      },
    });
    expect(
      envoieEmailService.envoieNotificationProposition,

...
describe("ValiderSaisieObjectifsHandler", () => {
  ...
  describe("execute", () => {
    it(
      "doit marquer les objectifs comme validés",
      createIntegrationTest(async (tx) => {
        ...
        expect(etapeUpdated.criteres_valides).toBe(false);
      }),
    );
    ...
    it(
      "peut valider les objectifs même si les critères sont déjà validés",
      createIntegrationTest(async (tx) => {
        // Given
        const fiche = await fixtures.fiche({
          etape_courante: "AUTO_EVALUATION",
    ...
    it(
      "doit passer à l'étape CONSOLIDATION quand les critères sont déjà validés",
      createIntegrationTest(async (tx) => {
        // Given

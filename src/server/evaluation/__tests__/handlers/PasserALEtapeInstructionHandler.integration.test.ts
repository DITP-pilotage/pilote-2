  ...
  describe("execute", () => {
    ...
    it(
      ...
      createIntegrationTest(async (tx) => {
        ...
        await tx.fiche_evaluation.createMany({
          data: [
            {
        ...
        await tx.etape_evaluation.createMany({
          data: [
            {
        ...
        const etapesInstruction = await tx.etape_evaluation.findMany({
          where: {
            fiche_evaluation_id: {
              in: [ficheEvaluationId1, ficheEvaluationId2],
            },
            type: "INSTRUCTION",
          },
        });
    ...
    it(
      ...
      createIntegrationTest(async (tx) => {
        ...
        await tx.referentiel_critere.createMany({
          data: [
            {
              id: critereId1,
              libelle: "Critère 1",

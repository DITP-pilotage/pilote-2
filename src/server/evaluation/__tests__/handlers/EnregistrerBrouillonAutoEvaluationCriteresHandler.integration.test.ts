...
describe("EnregistrerBrouillonAutoEvaluationCriteresHandler", () => {
  ...
  describe("execute", () => {
    it("doit créer de nouvelles évaluations de critères quand aucune n'existe", async () => {
      // Given
      ...
      await prisma.utilisateur.create({
        data: {
          id: utilisateurId,
          email: "test-criteres@example.com",
          nom: "Test",
          prenom: "User",
    ...
    it("doit mettre à jour des évaluations de critères existantes", async () => {
      // Given
      ...
      await prisma.utilisateur.create({
        data: {
          id: utilisateurId,
          email: "test-criteres2@example.com",
          nom: "Test2",
          prenom: "User",
          date_creation: new Date(),
          profilCode: "DITP_ADMIN",
    ...
    it("doit mettre à jour la date de modification de l'étape", async () => {
      ...
      await prisma.utilisateur.create({
        data: {
          id: utilisateurId,
          email: "test-criteres3@example.com",
          nom: "Test3",
          prenom: "User",
          date_creation: new Date(),
          profilCode: "DITP_ADMIN",
    ...
    it("doit gérer les notes nulles pour les critères", async () => {
      ...
      await prisma.utilisateur.create({
        data: {
          id: utilisateurId,
          email: "test-criteres4@example.com",
          nom: "Test4",
          prenom: "User",
          date_creation: new Date(),
          profilCode: "DITP_ADMIN",
    ...
    it("doit échouer si la fiche n'est pas en étape AUTO_EVALUATION", async () => {
      ...
      await prisma.utilisateur.create({
        data: {
          id: utilisateurId,
          email: "test-criteres5@example.com",
          nom: "Test5",
          prenom: "User",
          date_creation: new Date(),
          profilCode: "DITP_ADMIN",

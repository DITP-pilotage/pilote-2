...
describe("PrismaErreurValidationFichierRepository", () => {
  ...
  describe("#sauvegarder", () => {
    it("doit sauvegarder les données", async () => {
      ...
      expect(resultListeErreursValidationFichier[0].position_de_ligne).toEqual(
        1,
      );
      expect(resultListeErreursValidationFichier[0].position_du_champ).toEqual(
        1,
      );
      ...
      expect(resultListeErreursValidationFichier[1].position_de_ligne).toEqual(
        2,
      );
      expect(resultListeErreursValidationFichier[1].position_du_champ).toEqual(
        2,
      );
    });
  });

...
export default class InitialiserNouvelIndicateurUseCase {
  ...
  async run(indicId: string): Promise<MetadataParametrageIndicateur> {
    ...
    return MetadataParametrageIndicateur.creerMetadataParametrageIndicateur({
      ...
      projetAnnuelPerf: listeInformation.projet_annuel_perf.metaPiloteDefaultValue as string,
      ...
      indicTerritorialise: listeInformation.indic_territorialise.metaPiloteDefaultValue as string,
      ...
      donneeOuverte: listeInformation.donnee_ouverte.metaPiloteDefaultValue as string,
      ...
      commentaires: listeInformation.commentaires.metaPiloteDefaultValue as string,
    });
  }
}

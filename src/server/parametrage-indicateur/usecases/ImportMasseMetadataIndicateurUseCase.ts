...
const convertirEnImportMetadataIndicateur = (record: RecordCSVImport): ImportMetadataIndicateur => ({
  ...
  indicIsPerseverant: (record.indic_is_perseverant && record.indic_is_perseverant.toLowerCase() === 'true') || false,
  indicIsPhare: (record.indic_is_phare && record.indic_is_phare.toLowerCase() === 'true') || false,
  indicIsBaro: (record.indic_is_baro && record.indic_is_baro.toLowerCase() === 'true') || false,
  ...
  indicHiddenPilote: (record.indic_hidden_pilote && record.indic_hidden_pilote.toLowerCase() === 'true') || false,
  ...
  projetAnnuelPerf: (record.projet_annuel_perf && record.projet_annuel_perf.toLowerCase() === 'true') || false,
  ...
  indicTerritorialise: (record.indic_territorialise && record.indic_territorialise.toLowerCase() === 'true') || false,
  ...
  donneeOuverte: (record.donnee_ouverte && record.donnee_ouverte.toLowerCase() === 'true') || false,
  ...
  cibleAttendue: (record.cible_attendue && record.cible_attendue.toLowerCase() === 'true') || false,

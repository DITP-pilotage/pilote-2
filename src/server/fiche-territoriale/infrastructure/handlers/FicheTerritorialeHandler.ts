...
import { presenterEnTauxAvancementGlobalTerritoireContrat } from "@/server/fiche-territoriale/app/contrats/TauxAvancementGlobalTerritoireContrat";
import { RécupérerTauxAvancementGlobalTerritoireUseCase } from "@/server/fiche-territoriale/usecases/RécupérerTauxAvancementGlobalTerritoireUseCase";
...
export const ficheTerritorialeHandler = () => {
  const recupererFicheTerritoriale = async (
    ...
    const avancementGlobalTerritoire =
      await new RécupérerTauxAvancementGlobalTerritoireUseCase({
        chantierRepository:
    ...
    const avancementAnnuelTerritoire =
      await new RécupérerTauxAvancementAnnuelTerritoireUseCase({
        chantierRepository:
          dependencies.getFicheTerritorialeChantierRepository(),
        territoireRepository:
          dependencies.getFicheTerritorialeTerritoireRepository(),

...
export const libellesTypesCommentaire: Record<TypeCommentaire, string> = {
  ...
  autresRésultatsObtenusNonCorrélésAuxIndicateurs:
    "Autres résultats obtenus (non corrélés aux indicateurs)",
...
export const consignesEcritureCommentaire: Record<TypeCommentaire, string> = {
  ...
  autresRésultatsObtenusNonCorrélésAuxIndicateurs:
    "Avez-vous constaté des résultats importants qui ne transparaissent pas dans les chiffres des indicateurs ?",
  ...
  exemplesConcretsDeRéussite:
    "Avez-vous des exemples de réussites au niveau national ou déconcentré qu'il vous semble utile de communiquer et de partager ?",
};

  ...
  chantiers: {
    ...
    alertes: (
      <ul className="fr-text--sm fr-mb-0">
        ...
        <li>
          La seconde alerte signale les chantiers pour lesquels le territoire sélectionné a un recul significatif vis-à-vis du taux d’avancement global national.
        </li>
        <li>

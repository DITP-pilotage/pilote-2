            ...
            <div className="fr-grid-row fr-grid-row--gutters fr-grid-row--center">
              <div className="fr-col-12 fr-col-lg-6 fr-py-8w">
                ...
                <p className="fr-text--xl">
                  ...
                  afin d'identifier les freins et obstacles rencontrés.
                  <br />
                  <br />
                  PILOTE sert ainsi à ajuster les actions entreprises, organiser
                  l'appui des administrations centrales et rendre les arbitrages
            ...
            <div className="fr-grid-row fr-grid-row--gutters fr-grid-row--center">
              <div className="fr-col-12">
                ...
                <p className="fr-text--lg">
                  ...
                  niveaux de l'organisation administrative.
                </p>
              </div>
            </div>
            <div className="fr-grid-row fr-grid-row--gutters fr-grid-row--center">
                ...
                <div className="fr-card">
                  ...
                  <div className="fr-p-4w">
                    ...
                    <p className="fr-text--lg fr-mb-0">
                      ...
                      rendre compte. Il permet d'identifier les freins et
                      blocages pour apporter l'appui aux équipes opérationnelles
                      sur le terrain ou susciter des arbitrages ministériels ou
                ...
                <div className="fr-card">
                  ...
                  <div className="fr-p-4w">
                    ...
                    <p className="fr-text--lg fr-mb-0">
                      ...
                      Gouvernement dans le territoire pour lequel ils sont
                      chargés d'en superviser la mise en œuvre. Dans une logique
                      de « management par exception », il leur permet
                      d'identifier les chantiers sur lesquels un appui est
                      nécessaire.
                    </p>
                  </div>
                </div>
                ...
                <div className="fr-card">
                  ...
                  <div className="fr-p-4w">
                    ...
                    <p className="fr-text--lg fr-mb-0">
                      ...
                      rendre compte des résultats obtenus. Il permet aussi
                      d'alerter sur les obstacles rencontrés afin de demander
                      des arbitrages, des ressources ou un appui du préfet, des
                      équipes régionales ou des administrations centrales.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="fr-grid-row fr-grid-row--gutters fr-grid-row--center">
              <div className="fr-col-12 fr-col-lg-8 fr-pr-md-4w">
                ...
                <p className="fr-text--lg">
                  ...
                  au niveau interministériel. Chaque trimestre, les ministères
                  présentent leurs résultats dans des réunions présidées par le
                ...
                <p className="fr-text--lg">
                  La DITP est chargée d'animer, sous l'autorité de la Première
                  ministre, le déploiement des politiques prioritaires du
                  ...
                  <div className="fr-card__body">
                    <div className="fr-card__content">
                      ...
                      <p className="fr-card__desc">
                        ...
                        des politiques publiques aux citoyens.
                      </p>
                    </div>
                  </div>

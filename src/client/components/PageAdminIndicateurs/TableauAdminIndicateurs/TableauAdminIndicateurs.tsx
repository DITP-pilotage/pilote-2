...
const TableauAdminIndicateurs: FunctionComponent = () => {
  ...
  return (
    <section className="[&_tbody>tr]:cursor-pointer [&_tbody>tr:hover:nth-of-type(even)]:bg-[var(--background-contrast-grey-hover)] [&_tbody>tr:hover:nth-of-type(odd)]:bg-[var(--background-alt-grey-hover)] [&_tbody_td]:max-w-[20px] [&_tbody_td]:overflow-hidden [&_tbody_td]:text-ellipsis [&_tbody_td]:whitespace-nowrap [&_nav_button]:rounded">
      {!!alerte && (

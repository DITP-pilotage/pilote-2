    ...
    <Accordion.Root collapsible type="single">
      <Accordion.Item value="auto-evaluation">
        ...
        <Accordion.Content>
          <div className="space-y-3">
            <p>
              L'auto-évaluation est la première étape du processus d'évaluation
              des territoires. Elle permet aux préfets de renseigner leurs
              propres appréciations sur les objectifs collectifs et les axes de
              la manière de servir.
            </p>
            <p>
              Chaque territoire est invité à évaluer 4 à 5 objectifs collectifs
              ainsi que 3 axes sur la manière de servir. Cette phase se déroule
              de décembre 2025 à début février 2026.
            </p>
            <p className="font-medium">
              Les auto-évaluations servent de base pour la phase d'appréciation
              qui suit.
            </p>
          </div>
        </Accordion.Content>
      ...
      <Accordion.Item value="instruction">
        ...
        <Accordion.Content>
          <div className="space-y-3">
            <p>
              L'instruction est la phase finale du processus d'évaluation, menée
              par la DITP (Direction interministérielle de la transformation
              publique).
            </p>
            <p>

...
import DétailsDroitsUtilisateurStyled from "@/components/PageUtilisateur/DétailsDroitsUtilisateur/DétailsDroitsUtilisateur.styled";
...
const DétailsDroitsUtilisateur: FunctionComponent<
    ...
    <DétailsDroitsUtilisateurStyled>
      ...
      <div className="fr-grid-row">
        <div className="fr-col-12 fr-col-md-6">
          <p className="fr-text--md bold fr-mb-1v">{labelTerritoires}</p>
        ...
        <div className="fr-col-12 fr-col-md-6">
          <p className="fr-text--md bold fr-mb-1v">{labelChantiers}</p>
          {chantiers.length === 0 ? (
            <AucunÉlément />
          ) : (
            chantiers.map((chantier) => (
              <ÉlémentAccessible key={`${id} ${chantier}`} libellé={chantier} />
            ))
          )}
        </div>
      </div>

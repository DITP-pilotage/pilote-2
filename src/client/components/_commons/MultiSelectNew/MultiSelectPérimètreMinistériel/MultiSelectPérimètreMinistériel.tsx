...
export const MultiSelectPérimètreMinistériel: FunctionComponent<MultiSelectPérimètreMinistérielProps> = ({
  ...
  useEffect(() => {
    setOptionsGroupées([{
      ...
      options: trierParOrdreAlphabétique<MultiSelectOptions>(listePerimetresMinisteriel.map(périmètreMinistériel => ({

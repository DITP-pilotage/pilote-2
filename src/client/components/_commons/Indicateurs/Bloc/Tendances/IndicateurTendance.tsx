...
const IndicateurTendance = () => {
  ...
  return (
    <div className='flex flex-direction-row fr-ml-2w fr-mb-2w fr-mr-1w'>
      <p className='fr-text--xs fr-text-title--blue-france'>
        <span
          aria-hidden='true'
      ...
      <p className='fr-text--xs texte-gris fr-ml-1w fr-pt-1v'>

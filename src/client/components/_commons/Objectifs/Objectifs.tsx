...
const Objectifs: FunctionComponent<ObjectifsProps> = ({ objectifs, réformeId, maille, nomTerritoire, tousLesTypesDObjectif, estEtendu = true, modeÉcriture = false, estInteractif = true }) => {
  return (
    <Bloc 

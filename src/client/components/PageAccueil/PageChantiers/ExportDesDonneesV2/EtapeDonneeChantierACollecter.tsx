      ...
      <div className='fr-fieldset__element'>
        <div className='fr-checkbox-group'>
          ...
          <label
            ...
            htmlFor='identifiant'
          >
            identifiants de la PPG et du territoire
          </label>
        </div>
        ...
        <div className='fr-checkbox-group fr-mt-1w'>
          ...
          <label
            ...
            htmlFor='description'
          >
            données descriptives de la PPG sur le territoire
          </label>
        </div>
        <div className='fr-checkbox-group fr-mt-1w'>
          <input
          ...
          <label
            ...
            htmlFor='comparaison'
          >
            données de comparaison de la PPG
          </label>
        </div>
        <div className='fr-checkbox-group fr-mt-1w'>
          <input
          ...
          <label
            ...
            htmlFor='synthese'
          >
            météo et synthèse des résultats de la PPG sur le territoire
          </label>
        </div>
        <div className='fr-checkbox-group fr-mt-1w'>
          <input
        ...
        <div className='fr-checkbox-group fr-mt-1w'>
          ...
          <label
            ...
            htmlFor='decision'
          >
            suivi des décisions stratégiques de la PPG
          </label>
        </div>
      </div>

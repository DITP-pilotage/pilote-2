...
import BoutonsDeTri, {
  DirectionDeTri,
} from "@/components/_commons/Tableau/EnTête/BoutonsDeTri/BoutonsDeTri";
...
const TableauChantiersActionsDeTri: FunctionComponent<
      ...
      <div className="fr-select-group sélecteur-colonne-à-trier">
        ...
        <SélecteurCustom
          ...
          valeurModifiéeCallback={(triSélectionné) =>
            changementColonneÀTrierCallback(triSélectionné)
          }

      ...
      <div className="fr-fieldset__element fr-pl-0 fr-pb-2w border-b">
        ...
        <div className="fr-checkbox-group">
          <input
            ...
            type="checkbox"
          />
          <label className="fr-label fr-text--sm fr-mb-0" htmlFor="identifiant">
            <span>
              <span className="fr-text--bold">identifiants</span> du chantier et
              du territoire
            </span>
          </label>
        </div>
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          {afficherDetail ? (
            ...
            >
              <span>
                <span className="fr-text--bold">gouvernance</span> du chantier :
                tutelle, axe, spécificités (statut, présence dans le Baromètre,
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          {afficherDetail ? (
            ...
            >
              <span>
                <span className="fr-text--bold">responsabilité</span> du
                chantier : directeurs, responsables et coordinateurs
              </span>
            </label>
          ) : (
            <label
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          />
          {afficherDetail ? (
            <label className="fr-label fr-text--sm fr-mb-0" htmlFor="objectif">
              <span>
                <span className="fr-text--bold">objectifs</span> du chantier:
                notre ambition, ce qui a déjà été fait, ce qui reste à faire
              </span>
            </label>
          ) : (
            <label className="fr-label fr-text--sm fr-mb-0" htmlFor="objectif">
      ...
      <div className="fr-fieldset__element fr-pl-0 fr-pb-2w border-b">
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          {afficherDetail ? (
            ...
            >
              <span>
                <span className="fr-text--bold">données descriptives</span> du
                chantier sur le territoire : taux d'avancement, écart
              </span>
            </label>
          ) : (
            <label
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          {afficherDetail ? (
            ...
            >
              <span>
                <span className="fr-text--bold">données de comparaison</span> du
                chantier aux mailles inférieures et supérieures (si applicable)
                : taux d'avancement, écart
              </span>
            </label>
          ) : (
            <label
      ...
      <div className="fr-fieldset__element fr-pl-0">
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          <input
            ...
            type="checkbox"
          />
          <label className="fr-label fr-text--sm fr-mb-0" htmlFor="synthese">
            <span>
        ...
        <div className="fr-checkbox-group fr-mt-1w">
          ...
          {afficherDetail ? (
            <>
              ...
              >
                <span>
                  <span className="fr-text--bold">commentaires</span> du
                  chantier
                </span>
              </label>
              <ul className="fr-ml-4w fr-my-0 fr-text--sm">
                <li className="fr-pb-0">
                  sur les territoires départementaux et régionaux : commentaires
                  sur les données, autres résultats obtenus
                </li>
                <li className="fr-pb-0">
                  sur le territoire national : autres résultats obtenus, risques
                  et freins à lever, solutions et actions à venir, exemples
            ...
            >
              <span>
                <span className="fr-text--bold">commentaires</span> du chantier
              </span>
            </label>
          )}
        </div>
        {estAutoriseASelectionnerLesDecisionsStrategiques ? (
          <div className="fr-checkbox-group fr-mt-1w">
            <input
              ...
              type="checkbox"
            />
            <label className="fr-label fr-text--sm fr-mb-0" htmlFor="decision">
              <span>
                suivi des{" "}
                <span className="fr-text--bold">décisions stratégiques</span> du
                chantier
              </span>
            </label>
          </div>

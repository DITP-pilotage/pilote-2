...
export default function FiltresSélectionMultiple({
  ...
  const [filtresNew, setListeFiltresNew] = useQueryState(catégorieDeFiltre, parseAsArrayOf(parseAsString).withDefault([]).withOptions({ shallow: false, clearOnDefault: true }));

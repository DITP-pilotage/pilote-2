...
describe("#calculerNouvelleMaille", () => {
  ...
  it('nouveau filtre: "nationale, regionale" ', () => {
    expect(calculerNouvelleMaille(["nationale", "regionale"])).toBe(
      "regionale",
    );
  });

  it('nouveau filtre: "nationale, departementale" ', () => {
    expect(calculerNouvelleMaille(["nationale", "departementale"])).toBe(
      "departementale",
    );
  });
  ...
  it('nouveau filtre: "nationale, regionale, departementale" ', () => {
    expect(
      calculerNouvelleMaille(["nationale", "regionale", "departementale"]),
    ).toBe("departementale");
  });
  ...
  it('nouveau filtre: "regionale, departementale" ', () => {
    expect(calculerNouvelleMaille(["regionale", "departementale"])).toBe(
      "departementale",
    );
  });

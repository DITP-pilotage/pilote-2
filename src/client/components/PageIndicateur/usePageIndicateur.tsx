  ...
  const reactHookForm = useForm<MetadataIndicateurForm>(
    {
      ...
      defaultValues: {
        ...
        reformePrioritaire: indicateur.reformePrioritaire ? 'false' : 'true',
        indicTerritorialise: indicateur.indicTerritorialise ? 'false' : 'true',
        donneeOuverte: indicateur.donneeOuverte ? 'false' : 'true',

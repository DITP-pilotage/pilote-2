...
> = ({ données, chantiersSontArchives }) => {
  ...
  return (
    <section className="fr-table fr-m-0 fr-p-0 overflow-x-auto [&_tbody_a]:no-underline [&_tbody_a]:bg-none [&_.ligne-chantier]:cursor-pointer [&_.ligne-chantier:hover:nth-of-type(even)]:bg-[var(--background-contrast-grey-hover)] [&_.ligne-chantier:hover:nth-of-type(odd)]:bg-[var(--background-alt-grey-hover)]">

...
const EcartTauxAvancementPPG: FunctionComponent<EcartTauxAvancementPPGProps> = ({ ecart, estArchive }) => {
  ...
  return (
    <Badge type={estArchive ? 'gris' : couleurEcartArrondi.couleur}>
      <p className='fr-text--xs fr-mr-1v'>
        {couleurEcartArrondi.commentaire}
      </p>
      :

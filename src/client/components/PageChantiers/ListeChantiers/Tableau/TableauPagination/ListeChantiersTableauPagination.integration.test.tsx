...
import ListeChantiersTableauPagination from './ListeChantiersTableauPagination';
...
class ListeChantiersTableauPaginationTest {
...
describe('quand il y a plus de 5 pages', () => {
  ...
  donnéesDeTest.forEach((casDeTest) => {
    describe(`si la page courante est la page ${casDeTest.pageCourante}`, () => {
      let pagination: ListeChantiersTableauPaginationTest;
      beforeEach(() => {
        // GIVEN
        pagination = new ListeChantiersTableauPaginationTest();
        // WHEN

...
export default interface TerritoiresStore {
  ...
  actions: {
    ...
    modifierTerritoireSélectionné: (
      territoireCode: DétailTerritoire["code"],
    ) => void;
    ...
    récupérerCodesDépartementsAssociésÀLaRégion: (
      code: DétailTerritoire["code"],
    ) => DétailTerritoire["code"][];
  };
}

...
export function deuxTableauxSontIdentiques(
  tableau1: string[],
  tableau2: string[],
) {
...
export function toutesLesValeursDuTableauSontContenuesDansLAutreTableau(
  tableauContenu: (string | number | boolean | null)[],
  tableauContenant: (string | number | boolean | null)[],
) {
  return tableauContenu.every((element) => tableauContenant.includes(element));
}

export function auMoinsUneValeurDuTableauEstContenueDansLAutreTableau(
  tableau1: (string | number | boolean | null)[],
  tableau2: (string | number | boolean | null)[],
) {

  ...
  PAGE_IMPORT_MESURE_INDICATEUR: {
    SECTION_EXPLICATION_ETAPE_IMPORT: {
      ...
      ETAPE_SELECTION_INDICATEUR: {
        ...
        TEXTE:
          "Sélectionnez l'indicateur que vous souhaitez mettre à jour et cliquez sur le bouton “suivant”. Vous pourrez ensuite télécharger le modèle à remplir ou adapter votre fichier au formalisme demandé.",
      },
      ETAPE_CHARGER_FICHIER: {
        TITRE: "Charger le fichier",
        SOUS_TITRE_SELECTEUR: "Charger le fichier",
        TEXTE:
          "Dès que votre fichier vous semble correct, vous pouvez le charger pour vérifier que les données sont au bon format. Un rapport d'erreurs vous renseignera sur les potentiels éléments à adapter.",
      },
      ETAPE_PUBLIER_FICHIER: {
        ...
        TEXTE:
          "Prévisualisez vos données et validez la publication. Vous devrez ensuite attendre quelques jours pour que ces données soient prises en compte dans le calcul des taux d'avancement. Vous pouvez mettre à jour d'autres indicateurs.",
      },
    },
    SECTION_ETAPE_IMPORT: {
      ...
      ETAPE_SELECTION_INDICATEUR: {
        ...
        MESSAGE_ERREUR_AUCUN_INDICATEUR:
          "Ce chantier ne possède aucun indicateur",
        EXPLICATION_TELECHARGEMENT_TEMPLATE:
          "Si vous n'avez pas de fichier au bon format, téléchargez le modèle à remplir et consultez les règles et consignes de remplissage dans les ressources ci-dessous.",
        EXPLICATION_INDICATEUR_ID:
          "Le code de cet indicateur à renseigner dans la colonne identifiant_indic est : ",
      ...
      ETAPE_CHARGER_FICHIER: {
        TITRE:
          "Vos données doivent être au bon format pour être importées dans PILOTE",
        SOUS_TITRE:
        ...
        LABEL_BOUTON_CHARGER_FICHIER: (indicateurNom: string) =>
          `Ajouter un fichier pour l'indicateur ${indicateurNom}`,
        LABEL_BOUTON_PROCHAINE_ETAPE: "Suivant",
        TITRE_ALERT_SUCCES: "Bravo, le fichier est conforme !",
        MESSAGE_ALERT_SUCCES:
          "Passez à l'étape suivante pour prévisualiser les données et confirmer leur publication.",
        TITRE_ALERT_ERREUR: "Le fichier ne peut pas être importé",
        MESSAGE_ALERT_ERREUR:
          "Il contient des erreurs expliquées dans le rapport d'erreurs ci-dessous. Nous vous recommandons de consulter les ressources et/ou de remplir le modèle de fichier à remplir.",
        TITRE_ALERT_ERREUR_SUPPORT: "Le fichier ne peut pas être importé",
        MESSAGE_ALERT_ERREUR_SUPPORT:
          "Il contient des erreurs non identifiées. Nous vous recommandons de consulter les ressources, de remplir le modèle de fichier à remplir ou de contacter le support de la DITP: pilote.ditp@modernisation.gouv.fr.",
        TABLEAU_ERREUR: {
          ENTETE: {
            NOM: "Type d'erreur",
            CELLULE: "Cellule",
      ...
      ETAPE_PUBLIER_FICHIER: {
        ...
        TITRE_ALERT_SUCCES: (indicateurId: string) =>
          `Les données ont été importées avec succès pour l'indicateur ${indicateurId}`,
        MESSAGE_ALERT_SUCCES:
          "La mise à jour des taux d'avancement sera effective dans 2 heures. Vous pouvez, en attendant, mettre à jour d'autres indicateurs.",
    ...
    SECTION_RESSOURCE: {
      ...
      SECTION_EXPLICATION_IMPORT: {
        ...
        LISTE_CHAMPS: {
          IDENTIFIANT_INDIC: {
            ...
            EXPLICATION:
              "Identifiant unique de l'indicateur. Exemple : IND-001, IND-002, IND-003. (voir identifiant précisé plus haut sur la page)",
          },
          ZONE_ID: {
            CHAMP: "zone_id",
            EXPLICATION:
              "Identifiant du territoire pour lequel la donnée est renseignée. Il provient des référentiels INSEE et est interopérable. Exemple : D34, D20... (voir le référentiel ci-dessous)",
          },
          ZONE_NOM: {
            CHAMP: "zone_nom",
            EXPLICATION:
              "Champ facultatif précisant les territoires auxquels correspondent les zone-id. Vous n'êtes pas obligé(e) d'inclure cette colonne.",
          },
          DATE_VALEUR: {
            CHAMP: "date_valeur",
            EXPLICATION:
              "Date à laquelle se réfère la valeur numérique. La date doit être renseignée selon le modèle suivant année-mois-jour. Exemple : 2023-02-26, 2023-01-17...",
          },
          TYPE_VALEUR: {
            CHAMP: "type_valeur",
            EXPLICATION:
              "Type de données insérées : vi pour valeur initiale, va pour valeur d'avancement, vc pour valeur cible",
          },
          VALEUR: {
            CHAMP: "valeur",
            EXPLICATION:
              "Valeur de l'indicateur. La valeur doit être numérique. Ne pas saisir de texte (par exemple 'NC' ou 'non renseigné')",
          },
        },
      ...
      SECTION_CONTACT: {
        MESSAGE_CONTACT:
          "Si vous rencontrez des difficultés lors de l'import de votre fichier, merci de nous contacter à l'adresse : ",

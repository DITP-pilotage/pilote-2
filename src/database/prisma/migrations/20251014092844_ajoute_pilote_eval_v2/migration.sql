...
CREATE TABLE "public"."evaluation_critere" (
    ...
    CONSTRAINT "evaluation_critere_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "evaluation_critere_etape_evaluation_id_critere_id_auteur_id_key" ON "public"."evaluation_critere"("etape_evaluation_id", "critere_id", "auteur_id");
...
-- AddForeignKey
ALTER TABLE "public"."evaluation_critere" ADD CONSTRAINT "evaluation_critere_etape_evaluation_id_fkey" FOREIGN KEY ("etape_evaluation_id") REFERENCES "public"."etape_evaluation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."evaluation_critere" ADD CONSTRAINT "evaluation_critere_critere_id_fkey" FOREIGN KEY ("critere_id") REFERENCES "public"."referentiel_critere"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."evaluation_critere" ADD CONSTRAINT "evaluation_critere_auteur_id_fkey" FOREIGN KEY ("auteur_id") REFERENCES "public"."utilisateur"("id") ON DELETE CASCADE ON UPDATE CASCADE;

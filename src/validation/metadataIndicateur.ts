...
const metadata = presenterEnMapInformationMetadataIndicateurContrat(
  new YamlInformationMetadataIndicateurRepository().récupererInformationMetadataIndicateur(),
);
...
export const validationMetadataIndicateurFormulaire = z
  .object({
    indicParentIndic: z.string().nullable(),
    indicParentCh: z
      .string()
      .refine(
        (value) => /^CH-\d{3}$/.test(value),
    ...
    paramVacaDecumulFrom: z
      ...
      .refine(
        (value) =>
          new RegExp(metadata.param_vaca_decumul_from.metaPiloteEditRegex).test(
            value,
          ),
        metadata.param_vaca_decumul_from.metaPiloteEditRegexViolationMessage,
      ),
    paramVacaPartitionDate: z
      ...
      .refine(
        (value) =>
          new RegExp(
            metadata.param_vaca_partition_date.metaPiloteEditRegex,
          ).test(value),
        metadata.param_vaca_partition_date.metaPiloteEditRegexViolationMessage,
      ),
    paramVacaOp: z
      .string()
      .min(
        1,
        "Veuillez choisir une option valide pour l'Opération (TA annuel)",
      ),
    paramVacgDecumulFrom: z
      .string()
      .refine(
        (value) =>
          new RegExp(metadata.param_vacg_decumul_from.metaPiloteEditRegex).test(
            value,
          ),
        metadata.param_vacg_decumul_from.metaPiloteEditRegexViolationMessage,
      ),
    paramVacgPartitionDate: z
      ...
      .refine(
        (value) =>
          new RegExp(
            metadata.param_vacg_partition_date.metaPiloteEditRegex,
          ).test(value),
        metadata.param_vacg_partition_date.metaPiloteEditRegexViolationMessage,
      ),
    paramVacgOp: z
      .string()
      .min(
        1,
        "Veuillez choisir une option valide pour l'Opération (TA global)",
      ),
    poidsPourcentDept: z
      .string()
      .refine(
        (value) =>
          new RegExp(
            metadata.poids_pourcent_dept_declaree.metaPiloteEditRegex,
          ).test(value),
        metadata.poids_pourcent_dept_declaree
    ...
    poidsPourcentReg: z
      ...
      .refine(
        (value) =>
          new RegExp(
            metadata.poids_pourcent_reg_declaree.metaPiloteEditRegex,
          ).test(value),
        metadata.poids_pourcent_reg_declaree
          .metaPiloteEditRegexViolationMessage,
      ),
    poidsPourcentNat: z
      .string()
    ...
    delaiDisponibilite: z
      ...
      .refine(
        (value) =>
          new RegExp(metadata.delai_disponibilite.metaPiloteEditRegex).test(
            value,
          ),
    ...
    frequenceTerritoriale: z
      ...
      .refine(
        (value) =>
          new RegExp(metadata.frequence_territoriale.metaPiloteEditRegex).test(
            value,
          ),
    ...
    couvertureTemporelle: z
      ...
      .min(
        1,
        "Veuillez choisir une option valide pour la couverture temporelle",
      ),
  })
...
export const validationImportMetadataIndicateurFormulaire = z
  .object({
    indicParentIndic: z.string().nullable(),
    indicParentCh: z
      .string()

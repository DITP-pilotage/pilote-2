...
const createValidationMetadataIndicateurContexte = (
...
export const createValidationMetadataIndicateurFormulaire = (
  ...
  z
    .object({
      ...
      paramVacaDecumulFrom: z
        ...
        .refine(
          (value) =>
            new RegExp(
              metadata.param_vaca_decumul_from.metaPiloteEditRegex,
            ).test(value),
      ...
      paramVacaPartitionDate: z
        ...
        .refine(
          ...
          metadata.param_vaca_partition_date
      ...
      paramVacgDecumulFrom: z
        ...
        .refine(
          (value) =>
            new RegExp(
              metadata.param_vacg_decumul_from.metaPiloteEditRegex,
            ).test(value),
      ...
      paramVacgPartitionDate: z
        ...
        .refine(
          ...
          metadata.param_vacg_partition_date
            .metaPiloteEditRegexViolationMessage,
        ),
      paramVacgOp: z
        .string()
      ...
      frequenceTerritoriale: z
        ...
        .refine(
          (value) =>
            new RegExp(
              metadata.frequence_territoriale.metaPiloteEditRegex,
            ).test(value),
      ...
      maillePilotage: z
        ...
        .min(
          1,
          "Veuillez choisir une option valide pour la maille de pilotage",
        ),
    ...
    .and(createValidationMetadataIndicateurContexte(metadata))
...
export type ValidationMetadataIndicateurFormulaire = ReturnType<
  typeof createValidationMetadataIndicateurFormulaire
>;

export const createValidationImportMetadataIndicateurFormulaire = (
  metadata: MapInformationMetadataIndicateurContrat,
) =>
  z
    .object({
